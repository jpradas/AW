...
--
-- Servidor: localhost
-- Tiempo de generación: 08-01-2018 a las 10:23:56
...
--
ALTER TABLE `historial`
  ADD CONSTRAINT `historial_ibfk_1` FOREIGN KEY (`idPartida`) REFERENCES `partidas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
